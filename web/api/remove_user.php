...
require_once __DIR__ . "./../database/database/queries/admin_delete_queries/admin_delete_queries.php";
    ...
    if ($_SERVER["REQUEST_METHOD"] == "DELETE"){
        if (isset($_COOKIE['web-cookie'])) {
            ...
            if (json_last_error() === JSON_ERROR_NONE) {
                ...
                $adminDeleteQueries = new AdminDeleteQueries();
                $adminDeleteQueries->deleteUser($email);
